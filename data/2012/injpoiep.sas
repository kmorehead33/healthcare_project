*********************************************************************
 APRIL 23, 2013  1:57 PM
 
 This is an example of a SAS program that creates a SAS
 file from the 2012 NHIS Public Use INJPOIEP.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2012\INJPOIEP.dat';
...
PROC CONTENTS DATA=NHIS.INJPOIEP;
   TITLE1 'CONTENTS OF THE 2012 NHIS Episode FILE';

PROC FREQ DATA=NHIS.INJPOIEP NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2012 NHIS Episode FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA;
