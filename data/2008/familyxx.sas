*********************************************************************
 ...
 file from the 2008 NHIS Public Use FAMILYXX.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2008\FAMILYXX.dat';
...
"# of family members who got advice/test results over the phone, 2 wk"
      ...
      FHDSTCT    ="# of children currently or ever in Head Start"
...
"# of family members receive income from other Welfare programs"
   ...
   *    (PUT ASTERISK (*) BEFORE WORD "FORMAT"
   ...
   FORMAT
      ...
      INCGRP2   FAP087X.   INCGRP3   FAP088X.   RAT_CAT2  FAP089X.
      RAT_CAT3  FAP090X.   HOUSEOWN  FAP091X.   FGAH      FAP009X.
      FSSAPLYN  FAP009X.   FSDAPLYN  FAP009X.   FFDSTYN   FAP009X.
      FWICYN    FAP009X.;
RUN;

PROC CONTENTS DATA=NHIS.FAMILYXX;
   TITLE1 'CONTENTS OF THE 2008 NHIS Family FILE';

PROC FREQ DATA=NHIS.FAMILYXX NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2008 NHIS Family FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA_FAM;
