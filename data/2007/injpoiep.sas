*********************************************************************
 ...
 file from the 2007 NHIS Public Use INJPOIEP.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2007\INJPOIEP.dat';
...
PROC CONTENTS DATA=NHIS.INJPOIEP;
   TITLE1 'CONTENTS OF THE 2007 NHIS Episode FILE';

PROC FREQ DATA=NHIS.INJPOIEP NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2007 NHIS Episode FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA;
