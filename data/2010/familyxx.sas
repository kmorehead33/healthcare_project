*********************************************************************
 ...
 file from the 2010 NHIS Public Use FAMILYXX.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2010\FAMILYXX.dat';
...
PROC CONTENTS DATA=NHIS.FAMILYXX;
   TITLE1 'CONTENTS OF THE 2010 NHIS Family FILE';

PROC FREQ DATA=NHIS.FAMILYXX NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2010 NHIS Family FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA_FAM;
