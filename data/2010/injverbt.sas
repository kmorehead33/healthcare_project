*********************************************************************
 ...
 file from the 2010 NHIS Public Use INJVERBT.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2010\INJVERBT.dat';
...
PROC CONTENTS DATA=NHIS.INJVERBT;
   TITLE1 'CONTENTS OF THE 2010 NHIS Episode Verbatim FILE';

PROC FREQ DATA=NHIS.INJVERBT NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2010 NHIS Episode Verbatim FILE';
   TITLE2 '(UNWEIGHTED)';
