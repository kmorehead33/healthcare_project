*********************************************************************
 ...
 file from the 2010 NHIS Public Use INJPOIEP.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2010\INJPOIEP.dat';
...
PROC CONTENTS DATA=NHIS.INJPOIEP;
   TITLE1 'CONTENTS OF THE 2010 NHIS Episode FILE';

PROC FREQ DATA=NHIS.INJPOIEP NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2010 NHIS Episode FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA;
