*********************************************************************
 ...
 file from the 2014 NHIS Public Use FAMILYXX.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2014\FAMILYXX.dat';
...
PROC CONTENTS DATA=NHIS.FAMILYXX;
   TITLE1 'CONTENTS OF THE 2014 NHIS Family FILE';

PROC FREQ DATA=NHIS.FAMILYXX NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2014 NHIS Family FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA_FAM;
