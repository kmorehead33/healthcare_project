*********************************************************************
 ...
 file from the 2014 NHIS Public Use INJPOIEP.DAT ASCII file
...
FILENAME ASCIIDAT 'C:\NHIS2014\INJPOIEP.dat';
...
"Approximate time since injury/poisoning episode: Number of units"
      ...
      RPCKDMR    =
"Time between the date of injury/poisoning episode and questions were asked"
      RPD        =
"Days between the date of injury/poisoning episode and  questions were asked"
...
PROC CONTENTS DATA=NHIS.INJPOIEP;
   TITLE1 'CONTENTS OF THE 2014 NHIS Episode FILE';

PROC FREQ DATA=NHIS.INJPOIEP NOTITLE;
   TABLES RECTYPE/LIST MISSING;
   TITLE1 'FREQUENCY REPORT FOR 2014 NHIS Episode FILE';
   TITLE2 '(WEIGHTED)';
   WEIGHT WTFA;
